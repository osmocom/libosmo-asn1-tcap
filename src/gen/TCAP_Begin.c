...
asn_TYPE_member_t asn_MBR_TCAP_Begin_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TCAP_Begin, otid),
...
asn_TYPE_descriptor_t asn_DEF_TCAP_Begin = {
	...
	"Begin",
	&asn_OP_SEQUENCE,
	asn_DEF_TCAP_Begin_tags_1,
	sizeof(asn_DEF_TCAP_Begin_tags_1)
		/sizeof(asn_DEF_TCAP_Begin_tags_1[0]), /* 1 */
	asn_DEF_TCAP_Begin_tags_1,	/* Same as above */
	sizeof(asn_DEF_TCAP_Begin_tags_1)
		/sizeof(asn_DEF_TCAP_Begin_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
