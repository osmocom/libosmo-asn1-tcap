...
asn_TYPE_descriptor_t asn_DEF_TCAP_Unidirectional = {
	...
	"Unidirectional",
	&asn_OP_SEQUENCE,
	asn_DEF_TCAP_Unidirectional_tags_1,
	sizeof(asn_DEF_TCAP_Unidirectional_tags_1)
		/sizeof(asn_DEF_TCAP_Unidirectional_tags_1[0]), /* 1 */
	asn_DEF_TCAP_Unidirectional_tags_1,	/* Same as above */
	sizeof(asn_DEF_TCAP_Unidirectional_tags_1)
		/sizeof(asn_DEF_TCAP_Unidirectional_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
